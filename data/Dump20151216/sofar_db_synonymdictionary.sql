...
INSERT INTO `synonymdictionary` VALUES (2916,'delete','delete;remove',1,'s'),(2917,'finish','finish;complete;exit',1,'s'),(2918,'insert','insert;input;enter',1,'u'),(2919,'save','save;store;record',1,'s'),(2920,'display','display;show;present;print',1,'s'),(2921,'alert','notify;alert;alarm',1,'s'),(2927,'check','check;verify;validate',1,'s'),(2928,'request','request;submit;click',1,'u'),(2929,'choose','choose;select',1,'u'),(2932,'search','search;retrieve',1,'s'),(2933,'modify','modify;update;change',1,'s'),(2934,'modify','modify;change;update',1,'u');
